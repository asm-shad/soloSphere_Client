...
const JobDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${apiUrl}/add-bid`, bidData);
      // 2. Reset form
      form.reset();
      // 3. Show toast and Navigate
      toast.success("Bid Added Successful!!!");
      navigate("/my-bids");
    } catch (err) {
      console.log(err);
